...
INSERT INTO `notif_msg` (`id`, `type`, `title`, `content`, `recipient_id`, `recipient_name`, `sender_id`, `sender_name`, `read_status`, `priority`, `related_biz_id`, `related_biz_type`, `send_time`, `read_time`, `is_system`, `create_time`, `update_time`) VALUES ('1903065207775875074', 3, '审批通知', '你有一笔订单需要审批', '1896569037967204353', '负责人1', '1896569037967204353', '负责人1', 0, 0, 'OR20250321000005', 1, '2025-03-21 20:44:37', NULL, 1, '2025-03-21 20:44:37', '2025-03-21 20:44:37');
INSERT INTO `notif_msg` (`id`, `type`, `title`, `content`, `recipient_id`, `recipient_name`, `sender_id`, `sender_name`, `read_status`, `priority`, `related_biz_id`, `related_biz_type`, `send_time`, `read_time`, `is_system`, `create_time`, `update_time`) VALUES ('1903066668786176001', 3, '审批通知', '你有一笔订单需要审批', '1896569037967204353', '负责人1', '1896569037967204353', '负责人1', 0, 0, 'OR20250321000006', 1, '2025-03-21 20:50:26', NULL, 1, '2025-03-21 20:50:26', '2025-03-21 20:50:26');
INSERT INTO `notif_msg` (`id`, `type`, `title`, `content`, `recipient_id`, `recipient_name`, `sender_id`, `sender_name`, `read_status`, `priority`, `related_biz_id`, `related_biz_type`, `send_time`, `read_time`, `is_system`, `create_time`, `update_time`) VALUES ('1903068405811040258', 3, '审批通知', '你有一笔订单需要审批', '1896569037967204353', '负责人1', '1896569037967204353', '负责人1', 0, 0, 'OR20250321000007', 1, '2025-03-21 20:57:20', NULL, 1, '2025-03-21 20:57:20', '2025-03-21 20:57:20');
COMMIT;
...
INSERT INTO `order_in` (`id`, `order_no`, `type`, `order_type`, `creator`, `approver`, `inspector`, `expected_time`, `actual_time`, `total_amount`, `total_quantity`, `status`, `quality_status`, `remark`, `create_time`, `update_time`) VALUES ('1903053083020304386', 'OR20250321000003', 1, 1, '1896569037967204353', '1896569037967204353', '1898621397732356097', '2025-03-21 00:00:00', NULL, 114514.00, 1, 0, 0, '', '2025-03-21 19:56:27', '2025-03-21 19:56:27');
INSERT INTO `order_in` (`id`, `order_no`, `type`, `order_type`, `creator`, `approver`, `inspector`, `expected_time`, `actual_time`, `total_amount`, `total_quantity`, `status`, `quality_status`, `remark`, `create_time`, `update_time`) VALUES ('1903065062929801218', 'OR20250321000005', 1, 1, '1896569037967204353', '1896569037967204353', '1898621397732356097', '2025-03-31 00:00:00', NULL, 0.00, 1, 0, 0, '', '2025-03-21 20:44:03', '2025-03-21 20:44:03');
INSERT INTO `order_in` (`id`, `order_no`, `type`, `order_type`, `creator`, `approver`, `inspector`, `expected_time`, `actual_time`, `total_amount`, `total_quantity`, `status`, `quality_status`, `remark`, `create_time`, `update_time`) VALUES ('1903066667402063874', 'OR20250321000006', 1, 1, '1896569037967204353', '1896569037967204353', '1898621397732356097', '2025-03-31 00:00:00', NULL, 122.00, 1, 0, 0, '', '2025-03-21 20:50:25', '2025-03-21 20:50:25');
INSERT INTO `order_in` (`id`, `order_no`, `type`, `order_type`, `creator`, `approver`, `inspector`, `expected_time`, `actual_time`, `total_amount`, `total_quantity`, `status`, `quality_status`, `remark`, `create_time`, `update_time`) VALUES ('1903068405110599682', 'OR20250321000007', 1, 1, '1896569037967204353', '1896569037967204353', NULL, '2025-03-22 00:00:00', NULL, 229028.00, 4, 1, 0, '审批通过', '2025-03-21 20:57:20', '2025-03-22 00:31:23');
COMMIT;
...
CREATE TABLE `quality_inspection` (
  ...
  `status` tinyint(1) NOT NULL COMMENT '质检状态：1-通过，2-不通过，3-部分异常',
  `remark` varchar(500) DEFAULT NULL COMMENT '备注',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `update_time` datetime NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`),
